sprL = sprite_get_width(spr_icone_cristal) / 2;
sprA = sprite_get_height(spr_icone_cristal) / 2;
...
draw_sprite(spr_icone_cristal, 1, x1, y1);
if point_in_rectangle(xm, ym, x1 - sprL, y1 - sprA, x1 + sprL, y1 + sprA) {
	if (mouse_check_button(mb_left)){
		draw_sprite(spr_icone_cristal, 0, x1, y1);
